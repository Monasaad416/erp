...
class InvoiceGenerator
{
     ...
     * @return $this
     */
    public function setInvoiceBillingReference(BillingReference|null $billingReference): self
    {
     ...
     * @return $this
     */
    public function setInvoiceReturnReason(ReturnReason|null $returnReason): self
    {
        if($this->invoiceDocumentType != '388'){
    ...
    public function sendDocument(bool $isProduction = false): mixed
    {
        ...
        try {
            ...
            return ['success' => true,'response' => $response , 'hash' => $this->getInvoiceHashBaseEncoded() , 'xml' => $xml, 'signing_time' => $this->timestamp];
