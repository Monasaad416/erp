...
class AddEntry extends Component
{
    ...
    public function create()
    {
        ...
        $incomeSummaryLedger = Ledger::where('account_id',$incomeSummaryBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();//الاستاذ العام لمخلص الدخل مدين - دائن



        /***************************************************************************************************************بداية اقفال المشتريات */ 
        ...
        $purchasesBranchLedger = Ledger::where('account_id',$purchasesBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        /**************************************************************************************************************نهاية اقفال المشتريات */  


        /***************************************************************************************************************بداية اقفال مردودات المبيعات */ 
        ...
        $salesReturnsBranchLedger = Ledger::where('account_id',$salesReturnsBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        $waterBranchLedger = Ledger::where('account_id',$waterBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        if($entry3) {
          ...
          /***************************************************************************************************************نهاية اقفال استهلاك المياة */ 
        


        /***************************************************************************************************************بداية اقفال استهلاك الكهرباء */ 
        ...
        $electricityBranchLedger = Ledger::where('account_id',$electricityBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
       ...
       /***************************************************************************************************************نهاية اقفال استهلاك الكهرباء */ 


       /***************************************************************************************************************بداية اقفال استهلاك الهواتف */ 
        ...
        $phoneBranchLedger = Ledger::where('account_id',$phoneBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
    ...
    /***************************************************************************************************************نهاية اقفال استهلاك الهواتف */ 


    /***************************************************************************************************************بداية اقفال بند الايجارات */ 
        ...
        $rentBranchLedger = Ledger::where('account_id',$rentBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        /***************************************************************************************************************نهاية اقفال بند الايجارا */ 



        /***************************************************************************************************************بداية اقفال استهلاك الانترنت */ 
        ...
        $internetBranchLedger = Ledger::where('account_id',$internetBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        /***************************************************************************************************************بداية اقفال مصروفات الادوات المكتبية */ 
        ...
        $stationryBranchLedger = Ledger::where('account_id',$stationryBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
     ...
     /***************************************************************************************************************نهاية اقفال مصروفات الادوات المكتبية */ 

      /***************************************************************************************************************بداية اقفال مصروفات الانتقالات */ 
        ...
        $transportationBranchLedger = Ledger::where('account_id',$transportationBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        /***************************************************************************************************************نهاية اقفال مصروفات الانتقالات */ 

       /***************************************************************************************************************بداية اقفال مصروفات الحبر والطباعه */ 
        ...
        $printerBranchLedger = Ledger::where('account_id',$printerBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
      ...
      /***************************************************************************************************************نهاية اقفال مصروفات الحبر والطباعه */
     
      /***************************************************************************************************************بداية اقفال الاجور والمرتبات */
      // بند  مصروف  الاجور والمرتبات للفرع
        ...
        $salariesBranchLedger = Ledger::where('account_id',$salariesBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        /***************************************************************************************************************نهاية  اقفال الاجور والمرتبات */
        
        /***************************************************************************************************************بداية اقفال اهلاكات الاصول الثابتة */
        ...
        $buildingsDepreciationsBranchLedger = Ledger::where('account_id',$buildingsDepreciationsBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        $carsDepreciationsBranchLedger = Ledger::where('account_id',$carsDepreciationsBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        $computersDepreciationsBranchLedger = Ledger::where('account_id',$computersDepreciationsBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        $furnitureDepreciationsBranchLedger = Ledger::where('account_id',$furnitureDepreciationsBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        $posDevicesDepreciationsBranchLedger = Ledger::where('account_id',$posDevicesDepreciationsBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        /***************************************************************************************************************نهاية اقفال اهلاكات الاصول الثابتة */


        /***************************************************************************************************************بداية اقفال بنود ضريبة المدخلات والمخرجات  */ 
        //بند مصروفات تسوية الضرائب للفرع
        // حساب تسوية الضريبة للفرع
        $taxAdjustingAccountBranch = Account::select('id','name_'.LaravelLocalization::getCurrentLocale().' as name','account_num')
        ->where('Parent_account_num',2232)->where('branch_id',$this->branch_id)->first();
        $taxAdjustingAccountBranchLedger = Ledger::where('account_id',$taxAdjustingAccountBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
         // حساب ضرائب المدخلات للفرع
        $taxInAccountBranch = Account::select('id','name_'.LaravelLocalization::getCurrentLocale().' as name','account_num')
        ->where('Parent_account_num',1236)->where('branch_id',$this->branch_id)->first();
        $taxInAccountBranchLedger = Ledger::where('account_id',$taxInAccountBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
         // حساب ضرائب المخرجات للفرع
        $taxOutAccountBranch = Account::select('id','name_'.LaravelLocalization::getCurrentLocale().' as name','account_num')
        ->where('Parent_account_num',1236)->where('branch_id',$this->branch_id)->first();
        $taxOutAccountBranchLedger = Ledger::where('account_id',$taxOutAccountBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();

        //من ح تسوية الضريبة الي ح ضرائب المدخلات
        $entryForTaxInAdjusting = ClosingEntry::where('debit_account_id',$taxAdjustingAccountBranch->id)->where('credit_account_id',$taxInAccountBranch->id)
        ->where('start_date',$this->start_date)->where('end_date',$this->end_date)->first();
        if($entryForTaxInAdjusting) {
            $entryForTaxInAdjusting->debit_amount = $taxInAccountBranchLedger->sum('debit_amount') - $taxInAccountBranchLedger->sum('credit_amount');
            $entryForTaxInAdjusting->credit_amount = $taxInAccountBranchLedger->sum('debit_amount') - $taxInAccountBranchLedger->sum('credit_amount');
            $entryForTaxInAdjusting->updated_by = Auth::user()->id;
            $entryForTaxInAdjusting->save();

            $ledgerTaxIn = Ledger::where('account_id',$taxInAccountBranch->id)->where('type','closing_entry')->where('closing_entry_id',$entryForTaxInAdjusting->id)->first();
            $ledgerTaxAdjusting = Ledger::where('account_id',$taxAdjustingAccountBranch->id)->where('type','closing_entry')->where('closing_entry_id',$entryForTaxInAdjusting->id)->first();

            //الاستاذ العام لتسوية الضريبة المدين
            $ledgerTaxAdjusting->debit_amount = $entryForTaxInAdjusting->debit_amount;
            $ledgerTaxAdjusting->updated_by = Auth::user()->id;
            $ledgerTaxAdjusting->save();

            //الاستاذ العام لضرائب المدخلات دائن
            $ledgerTaxIn->credit_amount = $entryForTaxInAdjusting->debit_amount;
            $ledgerTaxIn->updated_by = Auth::user()->id;
            $ledgerTaxIn->save();
        } else {
            $entry = getNextClosingEntryNum();
            $entryForTaxInAdjusting = new ClosingEntry();
            $entryForTaxInAdjusting->entry_num = $entry;
            $entryForTaxInAdjusting->debit_account_num = $taxAdjustingAccountBranch->account_num;
            $entryForTaxInAdjusting->debit_account_id = $taxAdjustingAccountBranch ->id;
            $entryForTaxInAdjusting->credit_account_num = $taxInAccountBranch->account_num;
            $entryForTaxInAdjusting->credit_account_id = $taxInAccountBranch->id;
            $entryForTaxInAdjusting->debit_amount = $taxInAccountBranchLedger->sum('debit_amount') - $taxInAccountBranchLedger->sum('credit_amount');
            $entryForTaxInAdjusting->credit_amount = $taxInAccountBranchLedger->sum('debit_amount') - $taxInAccountBranchLedger->sum('credit_amount');
            $entryForTaxInAdjusting->branch_id = $this->branch_id;
            $entryForTaxInAdjusting->entry_type_id = 5 ;
            $entryForTaxInAdjusting->start_date = $this->start_date;
            $entryForTaxInAdjusting->end_date = $this->end_date;
            $entryForTaxInAdjusting->created_by = Auth::user()->id;
            $entryForTaxInAdjusting->updated_by = Auth::user()->id;
            $entryForTaxInAdjusting->description = "من ح  /  " .  $taxAdjustingAccountBranch->name  ."الي ح  /   ". $taxInAccountBranch->name  ;
            $entryForTaxInAdjusting->save();

            //الاستاذ العام لتسوية الضريبة المدين
            $ledgerTaxAdjusting = new Ledger();
            $ledgerTaxAdjusting->debit_amount = $entryForTaxInAdjusting->debit_amount;
            $ledgerTaxAdjusting->credit_amount = 0;
            $ledgerTaxAdjusting->account_id = $taxAdjustingAccountBranch->id;
            $ledgerTaxAdjusting->account_num = $taxAdjustingAccountBranch->account_num;
            $ledgerTaxAdjusting->name_ar= $taxAdjustingAccountBranch->name;
            $ledgerTaxAdjusting->created_by = Auth::user()->id;
            $ledgerTaxAdjusting->closing_entry_id = $entryForTaxInAdjusting->id;
            $ledgerTaxAdjusting->type = 'closing_entry';
            $ledgerTaxAdjusting->save();

            //الاستاذ العام لضرائب المدخلات دائن
            $ledgerTaxIn = new Ledger();
            $ledgerTaxIn->debit_amount = 0;
            $ledgerTaxIn->credit_amount = $entryForTaxInAdjusting->debit_amount;
            $ledgerTaxIn->account_id = $taxInAccountBranch->id;
            $ledgerTaxIn->account_num = $taxInAccountBranch->account_num;
            $ledgerTaxIn->name_ar= $taxInAccountBranch->name;
            $ledgerTaxIn->created_by = Auth::user()->id;
            $ledgerTaxIn->closing_entry_id = $entryForTaxInAdjusting->id;
            $ledgerTaxIn->type = 'closing_entry';
            $ledgerTaxIn->save();
        }

        //من حساب ضريبة المخرجات الي ح تسوية الضريبة
       $entryForTaxOutAdjusting = ClosingEntry::where('credit_account_id',$taxAdjustingAccountBranch->id)->where('debit_account_id',$taxOutAccountBranch->id)
        ->where('start_date',$this->start_date)->where('end_date',$this->end_date)->first();
        if($entryForTaxOutAdjusting) {
            $entryForTaxOutAdjusting->debit_amount = $taxOutAccountBranchLedger->sum('debit_amount') - $taxOutAccountBranchLedger->sum('credit_amount');
            $entryForTaxOutAdjusting->credit_amount = $taxOutAccountBranchLedger->sum('debit_amount') - $taxOutAccountBranchLedger->sum('credit_amount');
            $entryForTaxOutAdjusting->updated_by = Auth::user()->id;
            $entryForTaxOutAdjusting->save();

            $ledgerTaxOut = Ledger::where('account_id',$taxOutAccountBranch->id)->where('type','closing_entry')->where('closing_entry_id',$entryForTaxOutAdjusting->id)->first();
            $ledgerTaxAdjusting = Ledger::where('account_id',$taxAdjustingAccountBranch->id)->where('type','closing_entry')->where('closing_entry_id',$entryForTaxOutAdjusting->id)->first();

            //الاستاذ العام لتسوية الضريبة المدين
            $ledgerTaxAdjusting->debit_amount = $entryForTaxOutAdjusting->debit_amount;
            $ledgerTaxAdjusting->updated_by = Auth::user()->id;
            $ledgerTaxAdjusting->save();

            //الاستاذ العام لضرائب المدخلات دائن
            $ledgerTaxOut->credit_amount = $entryForTaxOutAdjusting->debit_amount;
            $ledgerTaxOut->updated_by = Auth::user()->id;
            $ledgerTaxOut->save();
        } else {
            $entry = getNextClosingEntryNum();
            $entryForTaxOutAdjusting = new ClosingEntry();
            $entryForTaxOutAdjusting->entry_num = $entry;
            $entryForTaxOutAdjusting->debit_account_num = $taxOutAccountBranch->account_num;
            $entryForTaxOutAdjusting->debit_account_id =  $taxOutAccountBranch->id;
            $entryForTaxOutAdjusting->credit_account_num = $taxAdjustingAccountBranch->account_num;
            $entryForTaxOutAdjusting->credit_account_id = $taxAdjustingAccountBranch->id;
            $entryForTaxOutAdjusting->debit_amount = $taxOutAccountBranchLedger->sum('debit_amount') - $taxOutAccountBranchLedger->sum('credit_amount');
            $entryForTaxOutAdjusting->credit_amount = $taxOutAccountBranchLedger->sum('debit_amount') - $taxOutAccountBranchLedger->sum('credit_amount');
            $entryForTaxOutAdjusting->branch_id = $this->branch_id;
            $entryForTaxOutAdjusting->entry_type_id = 5 ;
            $entryForTaxOutAdjusting->start_date = $this->start_date;
            $entryForTaxOutAdjusting->end_date = $this->end_date;
            $entryForTaxOutAdjusting->created_by = Auth::user()->id;
            $entryForTaxOutAdjusting->updated_by = Auth::user()->id;
            $entryForTaxOutAdjusting->description = "من ح  /  " .  $taxOutAccountBranch->name  ."الي ح  /   ". $taxAdjustingAccountBranch->name  ;
            $entryForTaxOutAdjusting->save();

            //الاستاذ العام لضريبة المخرجات المدين
            $ledgerTaxAdjusting = new Ledger();
            $ledgerTaxAdjusting->debit_amount = $entryForTaxOutAdjusting->debit_amount;
            $ledgerTaxAdjusting->credit_amount = 0;
            $ledgerTaxAdjusting->account_id = $taxOutAccountBranch->id;
            $ledgerTaxAdjusting->account_num = $taxOutAccountBranch->account_num;
            $ledgerTaxAdjusting->name_ar= $taxOutAccountBranch->name;
            $ledgerTaxAdjusting->created_by = Auth::user()->id;
            $ledgerTaxAdjusting->closing_entry_id = $entryForTaxOutAdjusting->id;
            $ledgerTaxAdjusting->type = 'closing_entry';
            $ledgerTaxAdjusting->save();
            ...
            $ledger162 = new Ledger();
            $ledger162->debit_amount = 0;
            $ledger162->credit_amount = $entryForTaxOutAdjusting->debit_amount;
            $ledger162->account_id = $taxAdjustingAccountBranch->id;
            $ledger162->account_num = $taxAdjustingAccountBranch->account_num;
            $ledger162->name_ar= $taxAdjustingAccountBranch->name;
            $ledger162->created_by = Auth::user()->id;
            $ledger162->closing_entry_id = $entryForTaxOutAdjusting->id;
            $ledger162->type = 'closing_entry';
            $ledger162->save();
        }

    /***************************************************************************************************************نهاية اقفال بنود ضريبة المدخلات والمخرجات  */ 
      ...
      //من ح المبيعات الي ح  ملخص الدخل
        ...
        $salesBranchLedger = Ledger::where('account_id',$salesBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
        ...
        $salesAssetsBranchLedger = Ledger::where('account_id',$salesAssetsBranch->id)->whereBetween('created_at',[$this->start_date,$this->end_date])->get();
