...
class AddUniTrailBalanceBefore extends Component
{
    ...
    public function create()
    {
        ...
        // dd(Account::select('id', 'name_' . LaravelLocalization::getCurrentLocale() . ' as name', 'account_num', 'level', 'is_parent')
//                 ->whereNot('account_num','like','311' .'%')->get());
        ...
        ->whereNot('account_num', 'like', '311' . '%')->get() as $account) {
            ...
            $trailBalance1 = UniTrailBalanceBefore::where('start_date', $this->start_date)
            ...
            if ($trailBalance1 != null) {
                ...
                $newTrailBalance1 = new UniTrailBalanceBefore();
                ...
                // $newTrailBalance1->branch_id = $account->branch_id;
            ...
            // foreach (Account::select('id', 'name_' . LaravelLocalization::getCurrentLocale() . ' as name', 'account_num', 'level', 'is_parent')->where('account_num', 'like', '221' . '%')->where('is_parent', 0)->get() as $supplierAccount) {
        ...
        return redirect()->route('uni-trail_balance_before');
        // } catch (Exception $e) {
        //     DB::rollback();
    ...
    {
        return view('livewire.uni-trail-balances-before.add-uni-trail-balance-before');
    }
}
