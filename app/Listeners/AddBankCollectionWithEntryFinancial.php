...
class AddBankCollectionWithEntryFinancial
{
    /**
    ...
    public function handle(object $event): void
    {
        ...
        //         //تسجيل العميل مدين الي المبيعات
        ...
        // //تحديث رصيد البنك 
        // $bank = Bank::where('branch_id', $transaction->branch_id)->first();
        // $bank->current_balance = +$transaction->receipt_amount;
        // $bank->save();
