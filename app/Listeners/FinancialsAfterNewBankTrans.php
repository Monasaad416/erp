...
class FinancialsAfterNewBankTrans
{
    /**
    ...
    public function handle(object $event): void
    {
        ...
        $bank = Bank::select('id',
            'name_'.LaravelLocalization::getCurrentLocale().' as name','account_num')->where('id',$bank_id)->first();
        ...
        $ledger1->account_id = $debitAccount1->account_num->id;
        $ledger1->account_num = $debitAccount1->account_num->account_num;
        ...
        $ledger2->account_id = $creditAccount1->account_num->id;
        $ledger2->account_num = $creditAccount1->account_num->account_num;
        ...
        $supplier->current_balance = $supplier->current_balance - $transaction->amount;
        $supplier->save();
