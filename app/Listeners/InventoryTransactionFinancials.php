...
class InventoryTransactionFinancials
{
    /**
      ...
      public function handle(object $event): void
   {
        ...
        //dd($creditLevels);
        foreach ($creditLevels as $relatedCreditLevel2) {

            $levelCreditAccount = Account::where('account_num',$relatedCreditLevel2)->first();
            //dd($levelCreditAccount->current_balance);
            $levelCreditAccount->update([
                'current_balance' => $levelCreditAccount->current_balance - $entry1->credit_amount,
            ]);
            //dd($levelCreditAccount->current_balance);
        }
