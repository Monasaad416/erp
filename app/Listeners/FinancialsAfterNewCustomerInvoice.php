...
class FinancialsAfterNewCustomerInvoice

{
    ...
    public function handle(object $event): void
    {
       ...
       //dd($invoice);
        ...
        //dd($customer->account_num);
        $debitAccount1 = Account::select('id','name_'.LaravelLocalization::getCurrentLocale().' as name','account_num')
        ...
        $creditAccountParent3 = Account::where('account_num','1224')->first();//حساب المخزون
        ...
        //قيد اليومية المركب
        //تسجيل العميل مدين - ايراد المبيعات دائن
        // debit1  & credit1
        ...
        $entry1->jounralable_type = 'App\Models\CustomerInvoice';
        ...
        // تسجيل العميل مدين - ضريبة المخرجات دائن
        ...
        $entry2->branch_id = $invoice->branch_id;
        $entry2->jounralable_type = 'App\Models\CustomerInvoice';
        ...
        $entry3->branch_id = $invoice->branch_id;
        $entry3->jounralable_type = 'App\Models\CustomerInvoice';
        ...
        //- مع الضريبة تكلفة البضاعة المباعة مدين
        $ledger2 = new Ledger();
        ...
        //- مع المخزون تكلفة البضاعة المباعة مدين
        $ledger3 = new Ledger();
        ...
        //الاستاذ العام لتكلفة  المخزون مدين
        ...
        $ledger6->save();
                ...
                // $tAccount6->description = "من ح ظ $debitAccount2->name";
        ...
        //تحديث رصيد العميل
        $customer->current_balance = $customer->current_balance + $invoice->total_after_discount;
        $customer->save();
