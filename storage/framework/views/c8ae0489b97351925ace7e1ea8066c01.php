        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo e(trans('admin.sure_change_state')); ?> <span class="text-danger"><?php echo e($treasuryName); ?></span></p>
...
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/treasuries/toggle-treasury.blade.php ENDPATH**/ ?>