...
<?php $component->withAttributes([]); ?>
    ...
    <div class="modal-header">
        <h5 class="tx-danger mg-b-20 mx-3 my-3">حذف منتج من قائمة المنتجات</h5>
    ...
    <div class="modal-body">
        ...
        <p>   <?php echo e(trans('admin.confirm_delete')); ?><?php echo "&nbsp;"; ?><?php echo "&nbsp;"; ?> <?php echo e($productName); ?> </p>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/products/delete-product.blade.php ENDPATH**/ ?>