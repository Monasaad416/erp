...
<?php $component = App\View\Components\UpdateModalComponent::resolve(['title' => 'تعديل بيانات المخزن'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
unset($__errorArgs, $__bag); ?>' placeholder = "<?php echo e(trans('admin.name_en')); ?>">
        ...
        <div class="col-6 mb-2">
            <div class="form-group">
                <label for='address_ar'><?php echo e(trans('admin.address_ar')); ?></label><span class="text-danger"> *</span>
                <input type="text" wire:model='address_ar' class= 'form-control mt-1 mb-3 <?php $__errorArgs = ['address_ar'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>' placeholder = "<?php echo e(trans('admin.address_ar')); ?>">
            </div>
            <?php echo $__env->make('inc.livewire_errors',['property'=>'address_ar'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <div class="col-6 mb-2">
            <div class="form-group">
                <label for='address_en'><?php echo e(trans('admin.address_en')); ?></label>
                <input type="text" wire:model='address_en' class= 'form-control mt-1 mb-3 <?php $__errorArgs = ['address_en'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>' placeholder = "<?php echo e(trans('admin.address_en')); ?>">
            </div>
            <?php echo $__env->make('inc.livewire_errors',['property'=>'address_en'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        ...
        <div class="col-6 mt-4">
            ...
            <div class="input-group-prepend">
                ...
                <input type="checkbox"  wire:model="is_parent"  <?php echo e($is_parent == 1 ? 'checked':''); ?> <?php echo e($is_parent == 0 ? 'disabled':''); ?>>
                </div>
            </div>
        ...
        <div class="col-6 mb-2">
            <div class="form-group">
                ...
                <select wire:model="branch_id" class="form-control"  <?php echo e($is_parent == 1 ? 'disabled':''); ?>>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/stores/update-store.blade.php ENDPATH**/ ?>