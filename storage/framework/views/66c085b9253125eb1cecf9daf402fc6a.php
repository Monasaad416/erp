...
<?php $component = App\View\Components\UpdateModalComponent::resolve(['title' => 'تعديل بيانات الخزينة'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
unset($__errorArgs, $__bag); ?>' placeholder = "<?php echo e(trans('admin.name_en')); ?>">
        ...
        <div class="col-6 mt-4">
            ...
            <div class="input-group-prepend">
                ...
                <input type="checkbox"  wire:model="is_parent" <?php echo e($is_parent == 1 ? 'checked' : ''); ?>>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/treasuries/update-treasury.blade.php ENDPATH**/ ?>