...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo e(asset('dashboard/assets/plugins/jquery-ui/jquery-ui.min.js')); ?>"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button)
</script>
<!-- Bootstrap 4 -->
<script src="<?php echo e(asset('dashboard/assets/plugins/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>


<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo e(asset('dashboard/assets/dist/js/pages/dashboard.js')); ?>"></script>

<script src="<?php echo e(asset('dashboard/assets/plugins/select2/js/select2.full.min.js')); ?>"></script>

<script src="<?php echo e(asset('dashboard/assets/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js')); ?>"></script>

<script src="<?php echo e(asset('dashboard/assets/dist/js/adminlte.min.js?v=3.2.0')); ?>"></script>
...
<!-- Dropify -->
<script src="<?php echo e(asset('dashboard/assets/dist/dropify-master/dist/js/dropify.min.js')); ?>"></script>
<script>
  $('.dropify').dropify();
</script>
         ...
         console.log("ee");
            document.addEventListener('keydown', function(event) {
                ...
                console.log(document.getElementById('newInvoice'));
                 window.location.href = "<?php echo e(route('customers.create_invoice')); ?>";
...
<?php /**PATH D:\laragon\www\pharma\resources\views/admin/layouts/footer_scripts.blade.php ENDPATH**/ ?>