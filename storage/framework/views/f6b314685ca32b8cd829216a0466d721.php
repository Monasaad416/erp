...
<?php $component = App\View\Components\CreateModalComponent::resolve(['title' => ''.e(trans('admin.create_user_shift')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-<?php echo e(Auth::user()->roles_name == 'سوبر-ادمن' ? 4:0); ?> mb-2">
                <div class="form-group">
                    <label for='branch_id'>الفرع</label><span class="text-danger">*</span>

                    <select wire:model.live='branch_id' wire:change.live="branchChanged" class='form-control  <?php $__errorArgs = ['branch_id'];
...
unset($__errorArgs, $__bag); ?>'>
            ...
            <div class="col-<?php echo e(Auth::user()->roles_name == 'سوبر-ادمن' ? 4:6); ?> mb-2">
                <div class="form-group">
                    ...
                    <select wire:model="user_id" class="form-control mt-1 mb-3 <?php $__errorArgs = ['user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        <option>إختر القائم علي الوردية الحالية </option>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = App\Models\User::where('branch_id',$branch_id)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                        
                        
                    </select>
                    <?php echo $__env->make('inc.livewire_errors', ['property' => 'user_id'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/treasury-shifts/add-treasury-shift.blade.php ENDPATH**/ ?>