        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><?php echo e(trans('admin.change_shift_approval_state')); ?></h4>
                ...
                <div class="modal-body">
                    <p><?php echo e(trans('admin.sure_change_shift_approval_state')); ?> <span class="text-danger"><?php echo e($deliveredToShift); ?></span></p>
...
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/treasury-shifts/approve-recieving-shift.blade.php ENDPATH**/ ?>