...
<?php $component->withAttributes([]); ?>
    <div class="modal-body tx-center pd-y-20 pd-x-20">
        <div class="modal-header">
            <h5 class="tx-danger mg-b-20 mx-3 my-3"><?php echo e(trans('admin.delete_shift_type_from_list')); ?></h5>
        ...
        <div class="modal-body">
            ...
            <p><?php echo e(trans('admin.sure_delete_treasury_shift')); ?> <?php echo "&nbsp;"; ?><?php echo e($delivered_to); ?> </p>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/treasury-shifts/delete-treasury-shift.blade.php ENDPATH**/ ?>