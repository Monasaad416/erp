...
<?php $component->withAttributes([]); ?>
    <div class="modal-body tx-center pd-y-20 pd-x-20">
        <div class="modal-header">
            <h5 class="tx-danger mg-b-20 mx-3 my-3"><?php echo e(trans('admin.delete_category_from_list')); ?></h5>
        ...
        <div class="modal-body">
            ...
            <p><?php echo e(trans('admin.confirm_delete')); ?> <?php echo "&nbsp;"; ?><?php echo e($categoryName); ?> </p>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/categories/delete-category.blade.php ENDPATH**/ ?>