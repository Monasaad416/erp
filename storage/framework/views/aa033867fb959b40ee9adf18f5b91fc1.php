                ...
                <div class="d-flex justify-content-center my-4">
                    <?php echo e($balances->links()); ?>
                            ...
                            <tbody>
                                    ...
                                    <tr wire:key="balance_type-<?php echo e($balance->id); ?>" style="background-color: <?php echo e($bg); ?>" >
                                        <td><?php echo e($loop->iteration); ?></td>
                                        <td><span class="text-dark"><?php echo e($debitBalane); ?></span> </td>
                                        <td><span class="text-dark"><?php echo e($creditBalane); ?></span> </td>
                                        <td><span class="text-dark"><?php echo e($totalbalance); ?></span> </td>
                                        <td><span class="text-dark"><?php echo e($balance->branch->name); ?></span> </td>
                                        <td><span class="text-dark"><?php echo e($balance->start_date); ?></span> </td>
                                        <td><span class="text-dark"><?php echo e($balance->end_date); ?></span> </td>
                                    </tr>
...
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/trail-balances-after/display-trail-balances-after.blade.php ENDPATH**/ ?>