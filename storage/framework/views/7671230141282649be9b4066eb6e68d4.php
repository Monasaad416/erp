...
unset($__errorArgs, $__bag); ?>' placeholder = "<?php echo e(trans('admin.name_en')); ?>">
        ...
        <div class="col-3 mb-2">
            <div class="form-group">
                <label for='unit_id'><?php echo e(trans('admin.unit')); ?> </label><span class="text-danger"> *</span>
...
unset($__errorArgs, $__bag); ?>'>
        ...
        <div class="col-3 mb-2">
            <div class="form-group">
                <label for='sale_price'><?php echo e(trans('admin.sale_price')); ?></label><span class="text-danger"> *</span>
...
unset($__errorArgs, $__bag); ?>'>
        ...
        <div class="col-2 mb-2">
            <div class="form-group">
                <label for='category_id'><?php echo e(trans('admin.category')); ?> </label><span class="text-danger"> *</span>
...
unset($__errorArgs, $__bag); ?>' placeholder = "<?php echo e(trans('admin.gtin')); ?>">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="input-group-prepend">
                ...
                <input type="checkbox" wire:model="fraction">
                </div>
            </div>
        ...
        <div class="col-6 mb-2">
            ...
            <div class="input-group-prepend">
                <div class="input-group-text">
                <input type="checkbox" wire:model="taxes">
                </div>
            </div>
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            $('#create_modal').on('shown.bs.modal', function () {
                Livewire.emit('change-focus-other-field');
            });
        });
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/products/add-product.blade.php ENDPATH**/ ?>