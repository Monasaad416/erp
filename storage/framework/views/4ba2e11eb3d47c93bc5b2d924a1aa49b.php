        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p><?php echo e(trans('admin.sure_change_state')); ?> <span class="text-danger"><?php echo e($categoryName); ?></span></p>
...
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/categories/toggle-category.blade.php ENDPATH**/ ?>