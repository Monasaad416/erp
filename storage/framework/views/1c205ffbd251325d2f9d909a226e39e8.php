...
<?php $component->withAttributes([]); ?>
    <div class="modal-body tx-center pd-y-20 pd-x-20">
        <div class="modal-header">
            <h5 class="tx-danger mg-b-20 mx-3 my-3">حذف رأس مال شريك من قائمة رأس المال</h5>
        ...
        <div class="modal-body">
            ...
            <p><?php echo e(trans('admin.confirm_delete')); ?> <?php echo "&nbsp;"; ?> راس مال بقيمة <?php echo e($amount); ?>  <?php echo "&nbsp;"; ?>  للشريك <?php echo "&nbsp;"; ?> <?php echo e($capitalPartner); ?> </p>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/capitals/delete-capital.blade.php ENDPATH**/ ?>