...
<?php $component = App\View\Components\UpdateModalComponent::resolve(['title' => ''.e(trans('admin.edit_user')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
unset($__errorArgs, $__bag); ?>' placeholder = " العمر">
            ...
            <div class="form-group">
                <label for='medical_insurance_deduction'>إستقطاعات التأمين الطبي</label>
...
unset($__errorArgs, $__bag); ?>' placeholder = "إستقطاعات التأمين الطبي ">
        ...
        <div class="col-4 mb-2">
            <div class="form-group">
                <label for='transfer_allowance'>بدل الإنتقالات</label>
...
unset($__errorArgs, $__bag); ?>' placeholder = " تاريج إنتهاء جواز السفر">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="input-group-prepend">
                ...
                <input type="checkbox" <?php echo e($has_driving_license == 1 ? 'checked' : ''); ?> wire:model="has_driving_license">
                </div>
            </div>
        ...
        <div class="col-6 mb-2">
            ...
            <div class="input-group-prepend">
                <div class="input-group-text">
                <input type="checkbox" <?php echo e($has_medical_insurance == 1 ? 'checked' : ''); ?>  wire:model="has_medical_insurance">
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\pharma\resources\views/livewire/users/update-user.blade.php ENDPATH**/ ?>