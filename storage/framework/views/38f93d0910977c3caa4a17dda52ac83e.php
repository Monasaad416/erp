    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!--[if BLOCK]><![endif]--><?php if($partnersWithdrawals->count() > 0): ?>
                    <style>
                        .table thead tr th{
                            text-align:center;
                        }
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $partnersWithdrawals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $withdrawal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td ><?php echo e($withdrawal->sourcable_type == "App\Models\Bank" ? App\Models\Bank::where('id',$withdrawal->sourcable_id)->first()->name_ar : App\Models\Treasury::where('id',$withdrawal->sourcable_id)->first()->name_ar); ?></td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn btn-outline-info btn-sm mx-1" title="تعديل"
                                            data-toggle="modal"
                                            wire:click="$dispatch('updatePartner',{id:<?php echo e($withdrawal->id); ?>})">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-outline-danger btn-sm mx-1"  title="حذف"
                                            data-toggle="modal"
                                            wire:click="$dispatch('deletePartner',{id:<?php echo e($withdrawal->id); ?>})">
                ...
                <div class="d-flex justify-content-center my-4">
                    <?php echo e($partnersWithdrawals->links()); ?>
...
</div><?php /**PATH D:\laragon\www\pharma\resources\views/livewire/partners-withdrawals/display-withdrawals.blade.php ENDPATH**/ ?>