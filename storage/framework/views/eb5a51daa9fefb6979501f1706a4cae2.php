            ...
            <div class="card card-body">
                <style>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php if($salaries): ?>
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
...
<?php else: ?>
        <p class="h4 text-muted text-center"><?php echo e(trans('admin.data_not_found')); ?></p>
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH D:\laragon\www\pharma\resources\views/inc/users/prev_year_salaries.blade.php ENDPATH**/ ?>