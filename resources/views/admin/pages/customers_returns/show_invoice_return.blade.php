...
@section('content')
    <div class="content-wrapper" style="min-height: 1302.4px;">
        ...
        <section class="content-header">
            ...
            <li class="breadcrumb-item"><a href="{{ route('customers.returns') }}">إشعارات الدائن</a></li>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <livewire:customer-invoices-returns.show-returns :invoiceReturn="$invoiceReturn"/>
