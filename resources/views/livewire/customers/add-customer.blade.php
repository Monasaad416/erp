<x-create-modal-component title="إضافة عميل">
    <div class="row">
        <div class="col-4 mb-2">
            <div class="form-group">
                <label for='name_ar'>{{trans('admin.name_ar')}}</label></label><span class="text-danger"> *</span>
        ...
        <div class="col-4 mb-2">
            <div class="form-group">
                <label for='phone'>{{trans('admin.phone')}}</label></label><span class="text-danger"> *</span>
...
{{--
        ...
        <div class="col-4 mb-2">
            <div class="form-group">
                ...
                <input type="number" min="0" step="any" wire:model='pos' class= 'form-control mt-1 mb-3 @error('pos') is-invalid @enderror' placeholder = "نقاط البيع">
            </div>
            @include('inc.livewire_errors',['property'=>'pos'])
        </div>
    </div>
