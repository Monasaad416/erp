    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">{{ trans('admin.partially_trans_item_to_returns') }}</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="bg-gray-200 p-4">
                                                <form wire:submit.prevent="returnInvoiceItemPartially">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <input type="number" min="0" step="any" wire:model="qty" class="form-control"  placeholder="{{ trans('admin.return_qty') }}">
