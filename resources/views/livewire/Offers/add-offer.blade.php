<x-create-modal-component title="إضافة عرض">
    @php
        $products = App\Models\Product::select('id','name_'.LaravelLocalization::getCurrentLocale().' as name')->get();
        $branches = App\Models\Branch::select('id','name_'.LaravelLocalization::getCurrentLocale().' as name')->whereNot('id',1)->get();
    @endphp
    @push('css')
    ...
    <div class="row">
        <div class="col-4 mb-2">
            <div class="form-group" >
                ...
                <select wire:model='product_id' class='form-control select2 mt-1 mb-3 @error('product_id') is-invalid @enderror'>
       ...
       <div class="col-2 mb-2">
        ...
        <div class="col-2 mb-2">
            <div class="form-group">
                ...
                <input wire:model='price' type="number" min="0"  class= 'form-control mt-1 mb-3 @error('price') is-invalid @enderror'>
            </div>
