<x-update-modal-component title="تعديل بيانات المخزن">
    @php
    ...
    <div class="row">
        ...
        <div class="col-6 mt-4">
            ...
            <div class="input-group-prepend">
                ...
                <input type="checkbox"  wire:model="is_parent"  {{ $is_parent == 1 ? 'checked':'' }} {{ $is_parent == 0 ? 'disabled':''}}>
                </div>
            </div>
        ...
        <div class="col-6 mb-2">
            <div class="form-group">
                ...
                <select wire:model="branch_id" class="form-control"  {{ $is_parent == 1 ? 'disabled':'' }}>
