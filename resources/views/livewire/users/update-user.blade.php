<x-update-modal-component title="{{trans('admin.edit_user')}}">
    @php
    ...
    <div class="row">
        ...
        <div class="col-6 mb-2">
            ...
            <div class="input-group-prepend">
                ...
                <input type="checkbox" {{ $has_driving_license == 1 ? 'checked' : '' }} wire:model="has_driving_license">
                </div>
            </div>
        ...
        <div class="col-6 mb-2">
            ...
            <div class="input-group-prepend">
                <div class="input-group-text">
                <input type="checkbox" {{ $has_medical_insurance == 1 ? 'checked' : '' }}  wire:model="has_medical_insurance">
                </div>
            </div>
