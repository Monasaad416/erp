<x-create-modal-component title="{{trans('admin.create_shift_type')}}">
    ...
    <div class="row">    
        ...
        <div class="col-4 mb-2">
            <div class="form-group">
                ...
                <input type="number" wire:model='total_hours' class= 'form-control mt-1 mb-3 @error('total_hours') is-invalid @enderror' placeholder = "{{trans('admin.total_hours')}}">
            </div>
