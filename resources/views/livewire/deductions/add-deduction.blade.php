<x-create-modal-component title="إضافة خصم">
        @php
    ...
    <div class="row">
        {{-- <div class="col-12 bg-danger py-2">إذا كان الخصم سوف يتم تطبيقة علي  سنة مالية قادمة فضلا قم بتسجيل السنة المالية اولا ثم أضف الخصم</div> --}}
        ...
        <div class="col-6 mb-2">
            <div class="form-group">
                <label for='amount'>مبلغ الخصم </label><span class="text-danger"> *</span>
                <input type="number" min="0" step="any" wire:model='amount' class= 'form-control mt-1 mb-3 @error('amount') is-invalid @enderror' placeholder = " مبلغ الخصم">
            </div>
