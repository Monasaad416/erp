<x-create-modal-component title="{{trans('admin.create_product')}}">
    @php
    ...
    <div class="row">
        ...
        <div class="col-3 mb-2">
            <div class="form-group">
                <label for='unit_id'>{{trans('admin.unit')}} </label><span class="text-danger"> *</span>
        ...
        <div class="col-3 mb-2">
            <div class="form-group">
                <label for='sale_price'>{{trans('admin.sale_price')}}</label><span class="text-danger"> *</span>
        ...
        <div class="col-2 mb-2">
            <div class="form-group">
                <label for='category_id'>{{trans('admin.category')}} </label><span class="text-danger"> *</span>
