<x-create-modal-component title="إضافة أصل ثابت">
    {{-- @push('css')
    ...
    <div class="row">
        ...
        <div class="col-4 mb-2">
            <div class="form-group">
                ...
                <input type="date" id="date"  wire:model='purchase_date' class= 'form-control mt-1 mb-3 @error('purchase_date') is-invalid @enderror' placeholder = "تاريخ الشراء">
            </div>
