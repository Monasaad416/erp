                     ...
                     @if($branch_id == null || $from_date == null || $to_date == null)
                        ...
                        <div class="col-{{ Auth::user()->roles_name == 'سوبر-ادمن' ? 4 : 6 }} mb-2">
                            <div class="form-group">
                                ...
                                <input type="date" wire:model="from_date" class="form-control @error('from_date') is-invalid @enderror" placeholder="من تاريخ:">
                        ...
                        <div class="col-{{ Auth::user()->roles_name == 'سوبر-ادمن' ? 4 : 6 }} mb-2">
                            <div class="form-group">
                                ...
                                <input type="date" wire:model="to_date" class="form-control @error('to_date') is-invalid @enderror" placeholder="إلي تاريخ:">
                    ...
                    <table class="table table-bordered" style="width: 100%" id="supp_inv">
                        <thead class="sticky-top top-0">
                            <tr>
                                ...
                                <th style="width: 70px">اخر سعر شراء</th>
                        ...
                        <tbody>
                            @foreach ($rows as $index => $row)
                                <tr>
                                    ...
                                    <td style="width: 70px">
                                        <input type="number" min="0"  step="any"  wire:model="rows.{{ $index }}.actual_qty" wire:input.blur.debounce.500ms="selectState({{ $index }})"  class="form-control inv-fields @error('actual_qty') is-invalid @enderror">
