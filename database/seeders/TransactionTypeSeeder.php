...
class TransactionTypeSeeder extends Seeder
{
    ...
    public function run(): void
    {
       $transactions = [
                        [
                            "name_en"=>"Check and recieve shift mony on  treasury",
                            "name_ar"=>"مراجعة واستلام نقدية وردية علي الخزينة",
                            "is_active"=> 1,
                        ...
                        [
                            ...
                            "name_ar"=>" تحويل نقدية  من خزينة الفرع الي الخزينة الرئيسية ",
                            "is_active"=> 1,
                        ...
                        [
                            "name_en"=>"Send mony  from branch treasury to main treasury",
                            "name_ar"=>"  استلام  نقدية بالخزينة الرئيسية من خزينة فرع ",
                            "is_active"=> 1,
                            "screen_name"=>"collection",
                            "is_internal_trans"=> 0,
                       ...
                       [
                        ...
                        [
                            "name_en"=>"Withdrawn from the bank",
                            "name_ar"=>" سحب من البنك",
                            "is_active"=> 1,
                            "screen_name"=>"collection",
                            "is_internal_trans"=> 0,
                        ],
